...
class ScriptRunner():
    BIAS_OPT_MODULE = "app_CTS.scripts.BiasOptimization"
    IV_CURVES_MODULE = "app_CTS.scripts.IVCurves"
    MAGNET_OPT_MODULE = "app_CTS.scripts.MagnetOptimization"
    DEFLUX_MODULE = "app_CTS.scripts.MixerDeflux"
    NOISE_TEMP_MODULE = "app_CTS.scripts.NoiseTemperature"
    Y_FACTOR_MODULE = "app_CTS.scripts.YFactor"
    AMP_STABILITY_MODULE = "app_CTS.scripts.AmplitudeStability"
    PHASE_STABILITY_MODULE = "app_CTS.scripts.PhaseStability"
    ENTRY_FUNCTION = "main"
    ...
    def start(self, cartTest:CartTest, **kwargs) -> tuple[bool, str]:
        ...
        cartTest.testSysName = self.testSysName
