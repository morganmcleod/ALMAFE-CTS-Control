...
class SidebandSource(SidebandSource_Interface):
    ...
    def setFrequency(self, 
            freqGHz: float,
            refSynthAmplitude: float = 20  # dBm
        ) -> tuple[bool, str]:
        self.refSynth.setFrequency(freqGHz / 18)
