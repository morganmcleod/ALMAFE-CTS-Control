...
from app_MTS2.routers.Chopper import router as chopperRouter
from app_MTS2.routers.Database import router as databaseRouter
from app_MTS2.routers.DataDisplay import router as dataDisplayRouter
from app_MTS2.routers.IFSystem import router as ifSystemRouter
from app_MTS2.routers.LO import router as loRouter
from app_MTS2.routers.RFSource import router as rfRouter
from app_MTS2.routers.TemperatureMonitor import router as tempsRouter
from app_MTS2.routers.ColdLoad import router as coldLoadRouter
from app_MTS2.routers.SpectrumAnalyzer import router as specAnRouter
from app_MTS2.routers.PowerDetect import router as powerDetectRouter
from app_MTS2.routers.MeasControl import router as measControlRouter
from app_MTS2.routers.MixerAssembly import router as mixerAssyRouter
from app_MTS2.routers.MixerTests import router as mixerTestsRouter
from app_MTS2.routers.NoiseTemperature import router as noiseTempRouter
from app_MTS2.routers.ReferenceSource import router as loRefRouter
from app_MTS2.routers.ReferenceSource import router as rfRefRouter
...
tags_metadata = [
    ...
    {
        "name": "IF system",
        "description": "Input switch, spectrum analyzer"
    },
    {
        "name": "LO",
    ...
    {
        "name": "Mixer assembly",
        "description": "coordinate action of mixer and LO"
    }, 
    {
        "name": "Mixer tests",
...
app.include_router(mixerAssyRouter, tags=["Mixer assembly"])
...
#     logger.info(f'{request.url} in {process_time:.2f} seconds')
#     return response
...
async def get_API_Version(callback:str = None):
    ...
    result = VersionResponse(name = "ALMAFE-MTS2 API",
