...
class SetLNA(BaseModel):
    ...
    pol is 0 or 1.  lna is 1 or 2.  These specifiy which LNA to bias.
...
class Preset(BaseModel):
    ...
    LNA01: SetLNA
    LNA02: SetLNA
    LNA11: Optional[SetLNA] = None
    LNA12: Optional[SetLNA] = None
    SIS01: SetSIS
    SIS02: SetSIS
    SIS11: Optional[SetSIS] = None
    SIS12: Optional[SetSIS] = None
