...
from Controllers.RFSource.Interface import RFSource_Interface
...
from Controllers.PBAController import PBAController
...
class RFAutoLevel():
    ...
    def __init__(self,
            ...
            rfSrcDevice: RFSource_Interface):
    ...
    def autoLevel(self, 
        ...
        self.rfSrcDevice.setOutputPower(self.controller.output)
        ...
        while not done and not error: 
            ...
            if self.controller.done and not self.controller.fail:
                ...
                self.rfSrcDevice.setOutputPower(setValue)
                time.sleep(self.settings.sleep)
